...
const SHELL_COPY = {
  ru: {
    ...
    agentStatusNeedsSelection: 'Агент найден, выберите подключение',
    agentStatusNoAgents: 'Агенты не подключены',
  ...
  en: {
    ...
    agentStatusNeedsSelection: 'Agent found, choose a connection',
    agentStatusNoAgents: 'No agents connected',
